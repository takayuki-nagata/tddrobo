...
MAX_AUDIT_LOOP_COUNT = int(os.environ.get("TDD_MAX_AUDIT_LOOP_COUNT", 2))
...
LLM_DYNAMIC_MIN_TOKENS = int(os.environ.get("TDD_LLM_DYNAMIC_MIN_TOKENS", 8192))
LLM_DYNAMIC_MAX_TOKENS = int(os.environ.get("TDD_LLM_DYNAMIC_MAX_TOKENS", 262144))
LLM_DYNAMIC_BUFFER_TOKENS = int(os.environ.get("TDD_LLM_DYNAMIC_BUFFER_TOKENS", 4096))
